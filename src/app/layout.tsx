...
export const metadata: Metadata = {
  title: "Coffee Corner - Your Favorite Cafe",
  description: "Enjoy the finest coffee at Coffee Corner. Discover our specialties and contact us for more details.",
  openGraph: {
    title: "Coffee Corner - Your Favorite Cafe",
    description: "Enjoy the finest coffee at Coffee Corner. Discover our specialties and contact us for more details.",
    url: "https://coffeecorner.com",
    siteName: "Coffee Corner",
    images: [{ url: "https://images.pexels.com/photos/6612575/pexels-photo-6612575.jpeg?auto=compress&cs=tinysrgb&h=650&w=940", alt: "A close-up view of a professional espresso machine with syrup bottles in a coffee shop setting." }],
    type: "website",
  },
  twitter: {
